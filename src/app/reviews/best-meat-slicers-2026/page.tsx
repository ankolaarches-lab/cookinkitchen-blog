...
const products = [
  {
    ...
    price: "$249.99",
    rating: 4.7,
    link: `https://www.amazon.com/s?k=ChefsChoice+615A+Premium+Meat+Slicer&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$149.99",
    rating: 4.5,
    link: `https://www.amazon.com/s?k=Cuisinart+Kitchen+Pro+7+5+Inch+Slicer&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$89.99",
    rating: 4.4,
    link: `https://www.amazon.com/s?k=SuperBuddy+Manual+Meat+Slicer&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$299.99",
    rating: 4.6,
    link: `https://www.amazon.com/s?k=BESWOOD+10+Inch+Electric+Meat+Slicer&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$79.99",
    rating: 4.3,
    link: `https://www.amazon.com/s?k=VonShef+7+5+Inch+Electric+Slicer&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$349.99",
    rating: 4.8,
    link: `https://www.amazon.com/s?k=HausundChef+Professional+Meat+Slicer&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <article>
          ...
          <div className="rounded-2xl overflow-hidden mb-8 shadow-lg">
            <img 
              src="/images/reviews/meat-slicers-2026.jpg" 
