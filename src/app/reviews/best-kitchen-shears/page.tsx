...
const products = [
  {
    ...
    price: "$19.99",
    rating: 4.9,
    link: `https://www.amazon.com/s?k=Dreamfarm+Scizza+Kitchen+Shears&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$14.99",
    rating: 4.7,
    link: `https://www.amazon.com/s?k=OXO+Good+Grips+Kitchen+Shears&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$12.99",
    rating: 4.6,
    link: `https://www.amazon.com/s?k=KitchenAid+Stainless+Multi+Purpose+Shears&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$34.95",
    rating: 4.8,
    link: `https://www.amazon.com/s?k=Wusthof+Kitchen+Shears+9+Inch&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
    ...
    <div className="min-h-screen bg-stone-50">
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <section className="mt-12 bg-emerald-50 rounded-2xl p-8 border border-emerald-100">
          ...
          <a href={`https://www.amazon.com/s?k=Dreamfarm+Scizza+Kitchen+Shears&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`} target="_blank" rel="noopener noreferrer" className="inline-block bg-emerald-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-emerald-700 transition">Buy on Amazon</a>
        </section>
