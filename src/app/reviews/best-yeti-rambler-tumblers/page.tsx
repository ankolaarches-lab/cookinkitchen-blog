...
const products = [
  {
    ...
    rating: 4.8,
    reviews: "144,772",
    link: `https://www.amazon.com/s?k=YETI+Rambler+Stainless+Insulated+MagSlider&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    rating: 4.8,
    reviews: "45,321",
    link: `https://www.amazon.com/s?k=YETI+Rambler+Insulated+Leakproof+Stainless&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        <div className="mb-6">
          <Breadcrumbs items={[
            ...
            { label: 'Best YETI Rambler Tumblers 2026', href: '/reviews/best-yeti-rambler-tumblers' }
          ]} />
        </div>
