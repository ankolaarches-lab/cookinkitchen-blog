...
const products = [
  {
    ...
    price: "$99.95",
    rating: 4.9,
    link: `https://www.amazon.com/s?k=Zojirushi+NS-LAC05XT&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$89.95",
    rating: 4.8,
    link: `https://www.amazon.com/s?k=Instant+Pot+Duo&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$149.99",
    rating: 4.7,
    link: `https://www.amazon.com/s?k=Tiger+JKT-S10U&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$34.99",
    rating: 4.6,
    link: `https://www.amazon.com/s?k=Hamilton+Beach+30865A&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$39.99",
    rating: 4.5,
    link: `https://www.amazon.com/s?k=Aroma+ARC-914SBD&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$59.99",
    rating: 4.7,
    link: `https://www.amazon.com/s?k=Panasonic+SR-DF101&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
