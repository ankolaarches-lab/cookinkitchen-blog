...
const products = [
  {
    ...
    price: "$349.00",
    rating: 4.8,
    link: `https://www.amazon.com/s?k=Ooni+Koda+12+Pizza+Oven&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$599.95",
    rating: 4.7,
    link: `https://www.amazon.com/s?k=Breville+Smart+Oven+Pizza&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$449.00",
    rating: 4.6,
    link: `https://www.amazon.com/s?k=Ooni+Frya+12&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$299.99",
    rating: 4.5,
    link: `https://www.amazon.com/s?k=Ninja+Woodfire+Electric+Oven&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$149.99",
    rating: 4.4,
    link: `https://www.amazon.com/s?k=BakerStone+Pizza+Oven+Box&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$129.99",
    rating: 4.3,
    link: `https://www.amazon.com/s?k=Pizzacraft+PizzaQue&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
