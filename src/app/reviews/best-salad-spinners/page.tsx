...
const products = [
  {
    ...
    price: "$29.99",
    rating: 4.8,
    link: `https://www.amazon.com/s?k=OXO+Good+Grips+Salad+Spinner&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$24.99",
    rating: 4.6,
    link: `https://www.amazon.com/s?k=Chefn+Lettuce+Keep+It&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        <div className="mb-6">
          <Breadcrumbs items={[
            ...
            { label: 'Best Salad Spinners 2026', href: '/reviews/best-salad-spinners' }
          ]} />
        </div>
