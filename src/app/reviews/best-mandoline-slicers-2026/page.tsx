...
const products = [
  {
    ...
    price: "$34.95",
    rating: 4.8,
    link: `https://www.amazon.com/s?k=OXO+Good+Grips+Mandoline+Slicer&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$49.99",
    rating: 4.7,
    link: `https://www.amazon.com/s?k=Borner+V-Power+Mandoline&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$44.99",
    rating: 4.6,
    link: `https://www.amazon.com/s?k=KitchenAid+Mandoline+Slicer&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$39.99",
    rating: 4.5,
    link: `https://www.amazon.com/s?k=Mueller+Mandoline+Pro+Slicer&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$29.99",
    rating: 4.4,
    link: `https://www.amazon.com/s?k=Chef+n+Veggie+Chop&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <article>
          ...
          <div className="rounded-2xl overflow-hidden mb-8 shadow-lg">
            <img 
              src="/images/reviews/mandoline-slicer.jpg" 
