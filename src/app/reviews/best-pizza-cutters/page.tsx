...
const products = [
  {
    ...
    price: "$15.99",
    rating: 4.7,
    link: `https://www.amazon.com/s?k=DXISheng+Stainless+Pizza+Cutter&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$14.99",
    rating: 4.6,
    link: `https://www.amazon.com/s?k=KitchenAid+KF770DCOXAL+Pizza+Cutter&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
    pros: ["Sturdy", "Serrated edge", "Modern design", "Dishwasher safe"],
    cons: ["Only one style"],
  },
];

export default function BestPizzaCutters2026() {
  return (
    <div className="min-h-screen bg-stone-50">
      <header className="bg-gradient-to-r from-amber-600 to-orange-600 text-white py-16">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Best Pizza Cutters 2026</h1>
          <p className="text-xl text-amber-100 max-w-2xl mx-auto">Perfect pizza slices every time. We tested the best pizza cutters.</p>
        </div>
      </header>
      <main className="max-w-4xl mx-auto px-6 py-12">
        <div className="mb-6">
          <Breadcrumbs items={[
            ...
            { label: 'Best Pizza Cutters 2026', href: '/reviews/best-pizza-cutters' }
          ]} />
        </div>
