...
const products = [
  {
    ...
    price: "$199.95",
    rating: 4.8,
    link: `https://www.amazon.com/s?k=Breville+Die+Cast+2+Slice+Smart+Toaster&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$299.95",
    rating: 4.7,
    link: `https://www.amazon.com/s?k=Breville+Die+Cast+4+Slice+Smart+Toaster&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$89.99",
    rating: 4.6,
    link: `https://www.amazon.com/s?k=Cuisinart+4+Slice+Touchscreen+Toaster&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$24.99",
    rating: 4.5,
    link: `https://www.amazon.com/s?k=Hamilton+Beach+2+Slice+Toaster&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$79.99",
    rating: 4.5,
    link: `https://www.amazon.com/s?k=OXO+Good+Grips+2+Slice+Toaster&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
