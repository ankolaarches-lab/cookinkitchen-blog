...
const products = [
  {
    ...
    price: "$14.99",
    rating: 4.8,
    link: `https://www.amazon.com/s?k=Taylor+Precision+Products+Digital+Kitchen+Timer&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$24.99",
    rating: 4.7,
    link: `https://www.amazon.com/s?k=Sage+Kitchen+Timer&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$19.99",
    rating: 4.6,
    link: `https://www.amazon.com/s?k=OXO+Good+Grips+3+in+1+Kitchen+Timer&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$12.99",
    rating: 4.5,
    link: `https://www.amazon.com/s?k=TIMEGO+Digital+Kitchen+Timer&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$16.99",
    rating: 4.7,
    link: `https://www.amazon.com/s?k=KitchenAid+Mechanical+Kitchen+Timer&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$15.99",
    rating: 4.6,
    link: `https://www.amazon.com/s?k=JinYou+Magnetic+Kitchen+Timer&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
