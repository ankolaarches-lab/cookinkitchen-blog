...
const products = [
  ...
  },
  {
    ...
    price: "$18.99",
    rating: 4.8,
    link: `https://www.amazon.com/s?k=USA+Pan+Bakeware+Half+Sheet&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        <div className="mb-6">
          <Breadcrumbs items={[
            ...
            { label: 'Best Cookie Sheets 2026', href: '/reviews/best-cookie-sheets' }
          ]} />
        </div>
