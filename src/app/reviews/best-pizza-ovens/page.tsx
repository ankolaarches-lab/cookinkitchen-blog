...
const products = [
  {
    ...
    price: "$399.00",
    rating: 4.8,
    link: `https://www.amazon.com/s?k=Ooni+Koda+Portable+Pizza+Oven&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$229.99",
    rating: 4.6,
    link: `https://www.amazon.com/s?k=Ninja+Foodi+Pizza+Oven&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$599.95",
    rating: 4.7,
    link: `https://www.amazon.com/s?k=Breville+Smart+Oven+Pizzaiolo+BOV860BSS&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        <div className="mb-6">
          <Breadcrumbs items={[
            ...
            { label: 'Best Pizza Ovens 2026', href: '/reviews/best-pizza-ovens' }
          ]} />
        </div>
