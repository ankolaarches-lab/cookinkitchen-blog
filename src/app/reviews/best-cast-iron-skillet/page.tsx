...
const products = [
  {
    ...
    price: "$34.99",
    rating: 4.9,
    link: `https://www.amazon.com/s?k=Lodge+Pre+Seasoned+Skillet+12+Inch&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$369.95",
    rating: 4.8,
    link: `https://www.amazon.com/s?k=Le+Creuset+Enameled+Cast+Iron+Signature&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$85.00",
    rating: 4.7,
    link: `https://www.amazon.com/s?k=Field+Company+Cast+Iron+10+5+Inch&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$219.95",
    rating: 4.7,
    link: `https://www.amazon.com/s?k=Staub+Cast+Iron+11+Inch+Fry+Pan&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
