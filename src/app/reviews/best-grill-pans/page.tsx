...
const products = [
  {
    ...
    price: "$44.99",
    rating: 4.8,
    link: `https://www.amazon.com/s?k=Lodge+Pre+Seasoned+Cast+Iron+Grill&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$99.95",
    rating: 4.7,
    link: `https://www.amazon.com/s?k=Calphalon+Hard+Anodized+12+Inch+Grill&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        <div className="mb-6">
          <Breadcrumbs items={[
            ...
            { label: 'Best Grill Pans 2026', href: '/reviews/best-grill-pans' }
          ]} />
        </div>
