...
const products = [
  {
    ...
    rating: 4.6,
    reviews: "134,452",
    link: `https://www.amazon.com/s?k=DASH+Rapid+Egg+Cooker+Scrambled&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    rating: 4.4,
    reviews: "45,678",
    link: `https://www.amazon.com/s?k=Chefman+Electric+Egg+Countertop+Removable&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    rating: 4.5,
    reviews: "28,934",
    link: `https://www.amazon.com/s?k=Cuisinart+CEC+7+Egg+Cooker&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    rating: 4.3,
    reviews: "8,456",
    link: `https://www.amazon.com/s?k=Nordic+Ware+7+Egg+Breaky+Cooker&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    rating: 4.4,
    reviews: "32,156",
    link: `https://www.amazon.com/s?k=Mueller+Egg+Cooker+Steamer+Poacher&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
