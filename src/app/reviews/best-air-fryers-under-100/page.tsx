...
const products = [
  {
    ...
    price: "$89.99",
    rating: 4.7,
    link: `https://www.amazon.com/s?k=COSORI+Air+Fryer+5.8+Quart&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$99.95",
    rating: 4.6,
    link: `https://www.amazon.com/s?k=Instant+Pot+Vortex+Plus+7-in-1&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$89.99",
    rating: 4.5,
    link: `https://www.amazon.com/s?k=Ninja+Air+Fryer+4-Quart&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$79.99",
    rating: 4.4,
    link: `https://www.amazon.com/s?k=GoWISE+USA+5.8-Quart+Air+Fryer&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$59.99",
    rating: 4.3,
    link: `https://www.amazon.com/s?k=Dash+Tasti-Crisp+4-Quart&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
