...
const products = [
  {
    ...
    price: "$89.95",
    rating: 4.8,
    link: `https://www.amazon.com/s?k=Instant+Pot+Duo+Multi+Use+Pressure+Cooker&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$129.95",
    rating: 4.7,
    link: `https://www.amazon.com/s?k=Instant+Pot+Ultra+Multi+Use+Programmable&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$149.95",
    rating: 4.6,
    link: `https://www.amazon.com/s?k=Instant+Pot+Duo+Crisp+11+in+1&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$69.95",
    rating: 4.5,
    link: `https://www.amazon.com/s?k=Instant+Pot+Duo+Mini+3+Quart&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <article>
          ...
          <div className="rounded-2xl overflow-hidden mb-8 shadow-lg">
            <img 
              src="/images/reviews/pressure-cooker.jpg" 
