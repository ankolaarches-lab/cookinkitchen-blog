...
const products = [
  {
    ...
    price: "$24.99",
    rating: 4.8,
    link: `https://www.amazon.com/s?k=OXO+Good+Grips+Stainless+Colander&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$19.99",
    rating: 4.6,
    link: `https://www.amazon.com/s?k=Chefn+Space+Saving+Colander&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
    pros: ["Collapsible", "Space saving", "Colors", "Lightweight"],
    cons: ["Smaller capacity"],
  },
];

export default function BestColanders2026() {
  return (
    <div className="min-h-screen bg-stone-50">
      <header className="bg-gradient-to-r from-amber-600 to-orange-600 text-white py-16">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Best Colanders 2026</h1>
          <p className="text-xl text-amber-100 max-w-2xl mx-auto">Drain pasta like a pro. We tested the best colanders for every kitchen.</p>
        </div>
      </header>
      <main className="max-w-4xl mx-auto px-6 py-12">
        <div className="mb-6">
          <Breadcrumbs items={[
            ...
            { label: 'Best Colanders 2026', href: '/reviews/best-colanders' }
          ]} />
        </div>
