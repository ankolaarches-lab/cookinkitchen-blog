...
const products = [
  {
    ...
    price: "$49.99",
    rating: 4.8,
    link: `https://www.amazon.com/s?k=KitchenAid+KHM512ER+5+Speed+Hand&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$29.99",
    rating: 4.6,
    link: `https://www.amazon.com/s?k=Hamilton+Beach+62627+Handle+Mixer&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
    pros: ["Budget-friendly", "6 speeds", "Snap-on beaters", "Cord storage"],
    cons: ["Louder"],
  },
];

export default function BestHandMixers2026() {
  return (
    <div className="min-h-screen bg-stone-50">
      <header className="bg-gradient-to-r from-amber-600 to-orange-600 text-white py-16">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Best Hand Mixers 2026</h1>
          <p className="text-xl text-amber-100 max-w-2xl mx-auto">Lightweight power for everyday baking. We tested the best hand mixers.</p>
        </div>
      </header>
      <main className="max-w-4xl mx-auto px-6 py-12">
        <div className="mb-6">
          <Breadcrumbs items={[
            ...
            { label: 'Best Hand Mixers 2026', href: '/reviews/best-hand-mixers' }
          ]} />
        </div>
