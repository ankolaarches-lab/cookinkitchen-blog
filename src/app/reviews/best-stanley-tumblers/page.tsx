...
export const metadata: Metadata = {
  ...
  description: "Stanley Tumblers - Complete guide",
  openGraph: {
    title: "Stanley Tumblers",
    description: "Stanley Tumblers - Complete guide for home cooks",
    type: "article",
...
const products = [
  {
    ...
    rating: 4.7,
    reviews: "87,956",
    link: `https://www.amazon.com/s?k=STANLEY+Flowstate+3+Position+Compatible+Insulated&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    rating: 4.7,
    reviews: "14,494",
    link: `https://www.amazon.com/s?k=STANLEY+Quencher+ProTour+Tumbler+Sunrise&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    rating: 4.8,
    reviews: "34,567",
    link: `https://www.amazon.com/s?k=Stanley+Classic+Vacuum+Bottle+Hammertone&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    rating: 4.5,
    reviews: "8,234",
    link: `https://www.amazon.com/s?k=STANLEY+Adventure+Quencher+Tumbler+14oz&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    rating: 4.6,
    reviews: "12,876",
    link: `https://www.amazon.com/s?k=STANLEY+GoSeries+Water+Bottle+18oz&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
