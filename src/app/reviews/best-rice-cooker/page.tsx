...
const products = [
  {
    ...
    price: "$109.95",
    rating: 4.8,
    link: `https://www.amazon.com/s?k=Zojirushi+NS+LAC05+Uncooked+Premium+1+5+Liter&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$59.95",
    rating: 4.7,
    link: `https://www.amazon.com/s?k=Instant+Pot+Duo+Rice+Cooker&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$249.95",
    rating: 4.8,
    link: `https://www.amazon.com/s?k=Tiger+JKT+D10U+5+5+Cup+Keyboard+Cooker&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$34.99",
    rating: 4.4,
    link: `https://www.amazon.com/s?k=Aroma+Housewares+ARC+914SBD+8+Cup+Cooker&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
