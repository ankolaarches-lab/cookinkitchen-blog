...
const products = [
  {
    ...
    price: "$89.99",
    rating: 4.7,
    link: `https://www.amazon.com/s?k=Cuisinart+Chef+Classic+Stainless+Steel&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$64.99",
    rating: 4.5,
    link: `https://www.amazon.com/s?k=Rachael+Ray+Nonstick+12+Quart+Stockpot&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$99.99",
    rating: 4.6,
    link: `https://www.amazon.com/s?k=T+fal+Ultimate+Hard+Anodized+Stockpot&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$89.95",
    rating: 4.7,
    link: `https://www.amazon.com/s?k=Instant+Pot+Stainless+Steel+Multi+Cooker&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$49.99",
    rating: 4.4,
    link: `https://www.amazon.com/s?k=AmazonBasics+Stainless+Stockpot+12+Quart&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <article>
          ...
          <div className="rounded-2xl overflow-hidden mb-8 shadow-lg">
            <img 
              src="/images/reviews/stockpots-2026.jpg" 
