...
export const metadata: Metadata = {
  ...
  description: "Best Kitchen Scales - Complete guide",
  openGraph: {
    title: "Best Kitchen Scales",
    description: "Best Kitchen Scales - Complete guide for home cooks",
    type: "article",
...
const products = [
  {
    ...
    price: "$29.99",
    rating: 4.7,
    link: `https://www.amazon.com/s?k=Aura+Digital+Kitchen+Scale&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$34.99",
    rating: 4.8,
    link: `https://www.amazon.com/s?k=OXO+Good+Grips+Pop+Container&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        <div className="mb-6">
          <Breadcrumbs items={[
            ...
            { label: 'Best Kitchen Scales 2026', href: '/reviews/best-kitchen-scales' }
          ]} />
        </div>
