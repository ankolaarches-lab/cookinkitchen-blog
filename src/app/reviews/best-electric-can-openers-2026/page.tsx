...
const products = [
  {
    ...
    price: "$34.99",
    rating: 4.6,
    link: `https://www.amazon.com/s?k=Hamilton+Beach+Smooth+Touch+76625AS&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$29.99",
    rating: 4.5,
    link: `https://www.amazon.com/s?k=KitchenAid+Can+Opener+Stainless+KC110PSSLR&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$39.99",
    rating: 4.4,
    link: `https://www.amazon.com/s?k=Cuisinart+CCO+50+Deluxe+Can+Opener&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$24.99",
    rating: 4.5,
    link: `https://www.amazon.com/s?k=KitchenMama+Auto+Electric+Can+Opener&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$27.99",
    rating: 4.3,
    link: `https://www.amazon.com/s?k=Zelmiro+Electric+Can+Opener+Stainless&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
