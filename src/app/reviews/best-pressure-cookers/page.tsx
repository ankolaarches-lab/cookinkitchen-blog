...
export const metadata: Metadata = {
  ...
  description: "Best Pressure Cookers - Complete guide",
  openGraph: {
    title: "Best Pressure Cookers",
    description: "Best Pressure Cookers - Complete guide for home cooks",
    type: "article",
...
const products = [
  {
    ...
    price: "$89.95",
    rating: 4.8,
    link: `https://www.amazon.com/s?k=Instant+Pot+Duo+7+in+1&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$149.99",
    rating: 4.7,
    link: `https://www.amazon.com/s?k=Ninja+Foodi+Pressure+Cooker&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$129.95",
    rating: 4.8,
    link: `https://www.amazon.com/s?k=Instant+Pot+Ultra+10+in+1&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
