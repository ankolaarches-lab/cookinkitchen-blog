...
const products = [
  ...
  },
  {
    ...
    rating: 4.8,
    image: "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=600&h=400&fit=crop",
    link: "https://www.amazon.com/Nordic-Ware-Natural-Commercial-Baker/dp/B0063QUDB2?tag=cookinkitchen-20",
  ...
  },
  {
    ...
    rating: 4.7,
    image: "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=600&h=400&fit=crop",
    link: "https://www.amazon.com/KitchenAid-Premium-Silicone-Baking-Mat/dp/B07KPJHZ8F?tag=cookinkitchen-20",
  ...
  },
  {
    ...
    rating: 4.5,
    image: "https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=600&h=400&fit=crop",
    link: "https://www.amazon.com/AmazonBasics-Silicone-Baking-Mat/dp/B07X5T7Y8V?tag=cookinkitchen-20",
    ...
    <div className="min-h-screen bg-stone-50">
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <section className="mt-12 bg-emerald-50 rounded-2xl p-8 border border-emerald-100">
          ...
          <a href="https://www.amazon.com/Silpat-Classic-Non-Stick-Baking-Mat/dp/B0014CVE2E?tag=cookinkitchen-20" target="_blank" rel="noopener noreferrer" className="inline-block bg-emerald-600 text-white px-6 py-3 rounded-lg font-medium hover:bg-emerald-700 transition">Buy on Amazon</a>
        </section>
