...
const products = [
  {
    ...
    price: "$116.99",
    rating: 4.7,
    link: `https://www.amazon.com/s?k=Cosori+Stainless+Steel+Dehydrator&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$89.99",
    rating: 4.6,
    link: `https://www.amazon.com/s?k=Magic+Mill+Food+Dehydrator&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$69.99",
    rating: 4.5,
    link: `https://www.amazon.com/s?k=Nesco+FD-75A+Snackmaster+Pro&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$136.00",
    rating: 4.7,
    link: `https://www.amazon.com/s?k=LEM+Products+MightyBite+Dehydrator&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$29.99",
    rating: 4.4,
    link: `https://www.amazon.com/s?k=Elite+Gourmet+Food+Dehydrator&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <article>
          ...
          <div className="rounded-2xl overflow-hidden mb-8 shadow-lg">
            <img 
              src="/images/reviews/food-dehydrator.jpg" 
