...
const products = [
  {
    ...
    price: "$29.99",
    rating: 4.7,
    link: `https://www.amazon.com/s?k=Fullstar+Kitchen+Utensil+Set&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$24.99",
    rating: 4.6,
    link: `https://www.amazon.com/s?k=Home+Hero+Kitchen+Utensil+18+Piece&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$34.99",
    rating: 4.5,
    link: `https://www.amazon.com/s?k=StarPack+Home+Kitchen+Utensil+Set&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$24.99",
    rating: 4.8,
    link: `https://www.amazon.com/s?k=KitchenAid+5+Piece+Nylon+Utensil&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
