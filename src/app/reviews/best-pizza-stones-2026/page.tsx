...
const products = [
  {
    ...
    price: "$79.00",
    rating: 4.8,
    link: `https://www.amazon.com/s?k=Baking+Steel+14-Inch+pizza+Steel&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$34.99",
    rating: 4.7,
    link: `https://www.amazon.com/s?k=Old+Stone+Oven+Pizza+Stone&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$49.99",
    rating: 4.6,
    link: `https://www.amazon.com/s?k=FibraMent+D-BO-1416+Pizza+Stone&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$54.99",
    rating: 4.6,
    link: `https://www.amazon.com/s?k=NerdChef+Steel+Pizza+Stone&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$19.99",
    rating: 4.4,
    link: `https://www.amazon.com/s?k=AmazonBasics+Pizza+Stone&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
