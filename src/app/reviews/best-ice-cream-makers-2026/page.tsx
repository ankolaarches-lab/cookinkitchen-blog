...
const products = [
  {
    ...
    price: "$199.99",
    rating: 4.7,
    link: `https://www.amazon.com/s?k=Ninja+Creami+Deluxe+Ice+Cream&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$114.99",
    rating: 4.6,
    link: `https://www.amazon.com/s?k=Cuisinart+ICE+30BCP1+Indulgence+1+Quart&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$79.99",
    rating: 4.5,
    link: `https://www.amazon.com/s?k=Cuisinart+ICE+21+1+Quart+Ice+Cream&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$149.99",
    rating: 4.6,
    link: `https://www.amazon.com/s?k=Ninja+SLUSHi+Max+Frozen+Drink&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$799.99",
    rating: 4.8,
    link: `https://www.amazon.com/s?k=Lello+4080+Musso+Lussino+Ice+Cream&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
