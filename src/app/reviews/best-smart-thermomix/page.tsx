      ...
      <div className="max-w-3xl mx-auto px-4">
        ...
        <article>
          ...
          <div className="prose prose-stone max-w-none font-lato">
            ...
            <p className="mb-4"><a href={`https://www.amazon.com/s?k=Thermomix+TM6+Motor+White&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`} target="_blank" rel="noopener noreferrer" className="text-emerald-600 font-medium hover:underline">Check Price on Amazon →</a></p>
          ...
          <div className="mt-12 bg-stone-100 rounded-xl p-6 border border-stone-200">
            ...
            <a href={`https://www.amazon.com/s?k=Thermomix+TM6+Motor+White&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`} target="_blank" rel="noopener noreferrer" className="text-emerald-600 font-medium hover:underline">Check Price on Amazon</a>
          </div>
        </article>
      </div>
    </div>
