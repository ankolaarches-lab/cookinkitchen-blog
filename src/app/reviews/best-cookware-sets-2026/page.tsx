...
const products = [
  {
    ...
    price: "$199.99",
    rating: 4.7,
    link: `https://www.amazon.com/s?k=GreenPan+Valencia+Pro+Ceramic+Nonstick+11+Piece+Set&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$349.99",
    rating: 4.8,
    link: `https://www.amazon.com/s?k=All-Clad+HA1+Hard-Anodized+Nonstick+10+Piece+Set&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$279.99",
    rating: 4.6,
    link: `https://www.amazon.com/s?k=Calphalon+Premier+Hard-Anodized+10+Piece+Set&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$199.99",
    rating: 4.5,
    link: `https://www.amazon.com/s?k=Tramontina+Tri-Ply+Clad+10+Piece+Stainless+Steel&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$59.99",
    rating: 4.7,
    link: `https://www.amazon.com/s?k=Lodge+Pre-Seasoned+Cast+Iron+3+Piece+Skillet+Set&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
