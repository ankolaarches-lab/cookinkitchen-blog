...
const products = [
  { name: "Nordic Ware Half Sheet", price: "$14.95", rating: 4.9, link: `https://www.amazon.com/s?k=best+sheet+pans&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`, pros: ["Natural aluminum", "USA made", "Durable"] },
];
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        <div className="mb-6">
          <Breadcrumbs items={[
            ...
            { label: 'Best Sheet Pans 2026', href: '/reviews/best-sheet-pans' }
          ]} />
        </div>
