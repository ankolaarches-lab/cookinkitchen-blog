...
const products = [
  {
    ...
    price: "$49.99",
    rating: 4.5,
    link: `https://www.amazon.com/s?k=Hamilton+Beach+3+Tier+Steamer&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$26.99",
    rating: 4.4,
    link: `https://www.amazon.com/s?k=Bella+2+Tier+Food+Steamer&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$34.99",
    rating: 4.3,
    link: `https://www.amazon.com/s?k=Amazon+Basics+Electric+Steamer+3+Tier&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$34.99",
    rating: 4.6,
    link: `https://www.amazon.com/s?k=Aroma+Housewares+6+Cup+Cooker+Steamer&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$24.99",
    rating: 4.7,
    link: `https://www.amazon.com/s?k=Tovolo+Stackable+Steamer+Basket&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
