...
const products = [
  {
    ...
    price: "$69.99",
    rating: 4.8,
    link: `https://www.amazon.com/s?k=Lodge+Enameled+Cast+Iron+Dutch+Oven&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$54.99",
    rating: 4.6,
    link: `https://www.amazon.com/s?k=Amazon+Basics+Enameled+Cast+Iron+Dutch+Oven&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$79.99",
    rating: 4.7,
    link: `https://www.amazon.com/s?k=Cuisinart+Enameled+Cast+Iron+Dutch+Oven&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$89.00",
    rating: 4.7,
    link: `https://www.amazon.com/s?k=Caraway+Dutch+Oven&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$59.99",
    rating: 4.5,
    link: `https://www.amazon.com/s?k=Tramontina+Enameled+Cast+Iron+Dutch+Oven&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
