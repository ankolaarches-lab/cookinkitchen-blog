...
const products = [
  {
    ...
    price: "$479.95",
    rating: 4.8,
    link: `https://www.amazon.com/s?k=Breville+Barista+Express+BES870XL&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$449.99",
    rating: 4.7,
    link: `https://www.amazon.com/s?k=DeLonghi+Dinamica+Plus+Automatic&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$229.00",
    rating: 4.6,
    link: `https://www.amazon.com/s?k=Nespresso+VertuoPlus++Deluxe&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$449.95",
    rating: 4.7,
    link: `https://www.amazon.com/s?k=Breville+Barista+Impress+BES885BSS&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$499.99",
    rating: 4.6,
    link: `https://www.amazon.com/s?k=Philips+5400+LatteGo+EP5447&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$159.99",
    rating: 4.4,
    link: `https://www.amazon.com/s?k=Casabrews+Espresso+Machine+20+Bar&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
