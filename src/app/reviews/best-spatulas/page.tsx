...
const products = [
  {
    ...
    price: "$19.99",
    rating: 4.8,
    link: `https://www.amazon.com/s?k=OXO+Good+Grips+Silicone+Spatula&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$24.99",
    rating: 4.7,
    link: `https://www.amazon.com/s?k=Di+Oro+Silicone+Spatula+Set&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
    pros: ["6-piece set", "Lifetime warranty", "Metal reinforced", "Great colors"],
    cons: ["Higher price"],
  },
];

export default function BestSpatulas2026() {
  return (
    <div className="min-h-screen bg-stone-50">
      <header className="bg-gradient-to-r from-amber-600 to-orange-600 text-white py-16">
        <div className="max-w-4xl mx-auto px-6 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Best Spatulas 2026</h1>
          <p className="text-xl text-amber-100 max-w-2xl mx-auto">From scraping bowls to flipping pancakes. We tested the best spatulas.</p>
        </div>
      </header>
      <main className="max-w-4xl mx-auto px-6 py-12">
        <div className="mb-6">
          <Breadcrumbs items={[
            ...
            { label: 'Best Spatulas 2026', href: '/reviews/best-spatulas' }
          ]} />
        </div>
