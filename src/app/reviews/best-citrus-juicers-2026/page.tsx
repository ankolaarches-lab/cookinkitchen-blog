...
const products = [
  {
    ...
    price: "$14.99",
    rating: 4.7,
    link: `https://www.amazon.com/s?k=Rated+Zulay+Premium+Quality+Squeezer&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$19.99",
    rating: 4.6,
    link: `https://www.amazon.com/s?k=Chefn+2751001+LemonDrop+Citrus&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$24.99",
    rating: 4.5,
    link: `https://www.amazon.com/s?k=KitchenAid+KT6090AQ+Citrus+Squeezer&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$29.99",
    rating: 4.8,
    link: `https://www.amazon.com/s?k=Dreamfarm+Fluicer+Citrus+Squeezer+Green&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$19.99",
    rating: 4.5,
    link: `https://www.amazon.com/s?k=OXO+Good+Grips+Citrus+Juicer&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
