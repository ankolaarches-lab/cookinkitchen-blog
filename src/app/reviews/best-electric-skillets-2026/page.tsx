...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: "article",
    images: ["/images/reviews/electric-skillet.jpg"],
  },
};
...
const products = [
  {
    ...
    price: "$205.00",
    rating: 4.7,
    link: `https://www.amazon.com/s?k=Zojirushi+Gourmet+dExpert+Electric+Skillet&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$112.00",
    rating: 4.6,
    link: `https://www.amazon.com/s?k=Cuisinart+Nonstick+Oval+Electric+Skillet&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$61.99",
    rating: 4.5,
    link: `https://www.amazon.com/s?k=Presto+16+Inch+Electric+Skillet+22+Quart&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$59.99",
    rating: 4.6,
    link: `https://www.amazon.com/s?k=Black+Decker+Electric+Skillet+Family+Size&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
  ...
  },
  {
    ...
    price: "$44.99",
    rating: 4.4,
    link: `https://www.amazon.com/s?k=Elite+Gourmet+Extra+Deep+Electric+Skillet&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
