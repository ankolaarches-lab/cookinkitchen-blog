  ...
  },
  {
    ...
    products: [
      ...
      },
      {
        ...
        price: "$",
        rating: 4.7,
        affiliateLink: `https://www.amazon.com/s?k=Lodge+Enameled+Dutch+Oven&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
        badge: "Best Budget",
      },
      {
        ...
        price: "$$",
        rating: 4.6,
        affiliateLink: `https://www.amazon.com/s?k=T-fal+Ultimate+Hard+Anodized+Cookware+Set&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
      },
    ],
  },
  {
    ...
    products: [
      {
        ...
        price: "$$$",
        rating: 4.8,
        affiliateLink: `https://www.amazon.com/s?k=KitchenAid+Artisan+Stand+Mixer&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
        badge: "Best Mixer",
      },
      {
        ...
        price: "$",
        rating: 4.7,
        affiliateLink: `https://www.amazon.com/s?k=Instant+Pot+Duo+7-in-1&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
        badge: "Best Value",
      },
      {
        ...
        price: "$$",
        rating: 4.5,
        affiliateLink: `https://www.amazon.com/s?k=Ninja+Foodi+9-in-1&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
      },
    ],
  },
  {
    ...
    products: [
      {
        ...
        price: "$",
        rating: 4.8,
        affiliateLink: `https://www.amazon.com/s?k=OXO+Good+Grips+Pop+Scale&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
        badge: "Best Scale",
      },
      {
        ...
        price: "$$",
        rating: 4.9,
        affiliateLink: `https://www.amazon.com/s?k=John+Boos+Maple+Cutting+Board&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
      },
      {
        name: "OXO Good Grips Cutting Board Set",
        price: "$",
        rating: 4.6,
        affiliateLink: `https://www.amazon.com/s?k=OXO+Good+Grips+Cutting+Board+Set&tag=${process.env.NEXT_PUBLIC_AMAZON_AFFILIATE_TAG}`,
      },
    ],
  },
];
